...
filename="../data/filenames.csv"#the recipe id stored in this file
...
for recipeId in recipeIds:
    filename='../data/taggedFiles/taggedFiles'+str(recipeId)+".csv"#this is our keywords
...
for recipeId2 in recipeId2s:#loop through each recipe
    ...
    filename='../data/foodwords/foodwords'+str(recipeId2)+".csv"#load processed ingredient files
    impWords=pandas.read_csv(filename,encoding='ISO-8859-1')#load the file
    testCase=[]
    foodwords=[]
    ...
    f_out = open('../data/predictions/predictions'+str(recipeId2)+'.csv','w')
